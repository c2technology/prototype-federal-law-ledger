...
- During the historical build, `main` represents effective law at the latest
  imported enactment, not current-day law until the chronology reaches the
  present.
- Later codifications and repeals may be researched early but change
  `effective/` only in their own chronological enactment PRs.
